...
const Terms = () => {
  return (
    <>  
        <div id="section6" className='container-fluid d-flex align-items-center'>
          <div className='row'>
          <div className='col-md-7 text-center text-md-start'>
          <h2 className="h2Dark">Información general</h2><br/>
          <p style={{textAlign: "justify"}}>
            
            Este sitio web es operado por Curzor con nombre comercial Curzor. En todo el sitio, los términos “nosotros”, “nos” y “nuestro” se refieren a Curzor con nombre comercial Curzor ofrece este sitio web, incluyendo toda la información, herramientas y servicios disponibles para ti en este sitio, el usuario, está condicionado a la aceptación de todos los términos, condiciones, políticas y notificaciones aquí establecidos.
            ...
            - En cualquiera de nuestras sucursales del país, presentando tu factura o ticket, uno de nuestros asesores de venta te ayudará en el proceso. - Solicitar la devolución dentro del plazo de devolución por correo electrónico.
            Condiciones
            ...
            - En cualquiera de nuestras sucursales del país, presentando tu factura o ticket, uno de nuestros asesores de venta te ayudará en el proceso. - Solicitar la devolución dentro del plazo de devolución por correo electrónico.
            Procedimiento
            1. Devolución del dinero (solo aplica para casos de garantía y ley de retracto): - A través de transferencia (cuenta de ahorros, cuenta corriente, ahorro a la mano): se realiza aproximadamente dentro de los diez días hábiles siguientes de recibir el producto nuevamente en nuestra bodega. - A través de reversión del pago: quince días hábiles después de recibir el producto en nuestra bodega. Ésta reversión corre por cuenta y orden de tu entidad bancaria, cualquier duda debes comunicarte directamente con ellos. - Cambio del producto (Sujeto a disponibilidad de inventario en el momento del cambio). Sólo se podrán realizar cambios por productos con valor igual o inferior al original y la diferencia en caso de aplicar, se entregará en un cupón para una nueva compra en la tienda online. En caso de no contar con disponibilidad para el cambio, se entregará el valor del producto(s) en un cupón para una nueva compra. - Cupón para realizar una nueva compra (Este cupón tiene validez por seis meses a partir de la fecha de creación). 2. Cambio del producto (Sujeto a disponibilidad de inventario en el momento del cambio). Sólo se podrán realizar cambios por productos con valor igual o inferior al original y la diferencia en caso de aplicar, se entregará en un cupón para una nueva compra en la tienda online. En caso de no contar con disponibilidad para el cambio, se entregará el valor del producto(s) en un cupón para una nueva compra. 3. Cupón para realizar una nueva compra (Este cupón tiene validez por tres meses a partir de la fecha de creación).
            ...
            Productos que no aplican para devolución: Productos digitales.
            Plazo de respuesta
            ...
            Preguntas acerca de los Términos de Servicio deben ser enviadas a curzor.co@gmail.com.

            Última actualización de este documento de términos y condiciones: 23/03/2022
            </p>
          </div>
          </div>
        </div>
