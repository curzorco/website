...
const Navbar_Es = ({s0="Nosotros",s1="Servicios",s2="Proceso de Desarrollo",s3="Contacto",s4="fa-solid fa-language fa-lg"}) =>{
                        ...
                        <ul className="navbar-nav ms-auto">
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink" style={{minWidth:"5rem",marginTop:"0.7rem"}}>
                                    <li><Link className="dropdown-item" to="/" onClick={()=>{setExpanded(false)}} onMouseUp={()=>{setExpanded(true)}}>Español</Link></li>
                                    <li><Link className="dropdown-item" to="/en" onClick={()=>{setExpanded(false)}} onMouseUp={()=>{setExpanded(true)}}>Inglés</Link></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
